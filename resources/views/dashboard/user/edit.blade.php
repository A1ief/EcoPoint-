    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Update informasi pengguna: {{ $user['nama'] ?? 'N/A' }}</p>
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            <form method="POST" action="{{ route('users.update', $user['id_user'] ?? ($user['id'] ?? '')) }}"
                class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="border-b border-gray-200 pb-6">
                    <h4 class="text-lg font-semibold text-gray-800 mb-4">Ubah Password (Opsional)</h4>
