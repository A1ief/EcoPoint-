    ...
    <nav class="nav-blur text-white py-4 px-6 shadow-lg fixed w-full top-0 z-50 transition-all duration-300">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex gap-8 items-center">
                ...
                <a href="#" class="bg-white text-green-600 px-6 py-2.5 rounded-full font-semibold hover:bg-green-50 transition shadow-lg hover:shadow-xl transform hover:scale-105 glow-on-hover">
                    Login
                </a>
            </div>
        ...
        <div id="mobileMenu" class="hidden md:hidden mt-4 space-y-3">
            ...
            <a href="#" class="block bg-white text-green-600 px-6 py-2 rounded-full font-semibold text-center">Login</a>
        </div>
    </nav>
