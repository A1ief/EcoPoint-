    ...
    <nav class="nav-blur text-white py-4 px-6 shadow-lg fixed w-full top-0 z-50 transition-all duration-300">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex gap-8 items-center">
                ...
                <a href="/login" class="bg-white text-green-600 px-6 py-2.5 rounded-full font-semibold hover:bg-green-50 transition shadow-lg hover:shadow-xl transform hover:scale-105 glow-on-hover">
                    Login
                </a>
            </div>
...
block bg-white text-green-600 px-6 py-2 rounded-full font-semibold text-center            <a href="/login" class="block bg-white text-green-600 px-6 py-2 rounded-full font-semibold text-center">Login</a>
        </div>
    </nav>
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="slide-in-left">
                    ...
                    <p class="text-l md:text-2xl mb-10 text-green-500 leading-relaxed">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <a href="#cara-kerja" class="bg-white text-green-600 hover:bg-green-50 px-10 py-5 rounded-full text-lg font-bold transition duration-300 shadow-2xl hover:shadow-green-300/50 transform hover:scale-105 inline-flex items-center gap-3 glow-on-hover">
                    ...
                    <div class="grid grid-cols-3 gap-8 mt-16 fade-in-up">
                        <div class="text-center transform hover:scale-110 transition">
                            ...
                            <div class="text-sm text-green-500 font-medium">Pengguna Aktif</div>
                        </div>
                        <div class="text-center transform hover:scale-110 transition">
                            <div class="text-4xl md:text-5xl font-bold mb-2">50Ton</div>
                            <div class="text-sm text-green-500 font-medium">Sampah Terolah</div>
                        </div>
                        <div class="text-center transform hover:scale-110 transition">
                            <div class="text-4xl md:text-5xl font-bold mb-2">100+</div>
                            <div class="text-sm text-green-500 font-medium">Bank Sampah</div>
                        </div>
                    </div>
                </div>
